...
const IMAGE_MARGIN_BOTTOM = '12px'
...
export function ProjectCard({ project }) {
  return (
    <a href={project.url} target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none', color: 'inherit' }}>
      <div style={{ border: `1px solid ${BORDER_COLOR}`, padding: '15px', width: CARD_WIDTH, height: CARD_HEIGHT, display: 'flex', flexDirection: 'column' }}>
        <h3 style={{ marginTop: 0, marginBottom: TITLE_MARGIN_BOTTOM, textAlign: 'center', flex: '0 0 auto' }}>{project.name}</h3>
